...
@section('content')
    <form action="{{ $user->patch() }}">
        ...
        <div class="mb-6">
            ...
            <input class="border border-gray-400 p-2 w-full" type="password_confirmation" name="password_confirmation" id="password_confirmation" required>
